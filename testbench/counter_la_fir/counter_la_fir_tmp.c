...
#define reg_mprj_slave2 (*(volatile uint32_t *) 0x30000008)
#define reg_mprj_slave_x_valid (*(volatile uint32_t *)  0x30000004)
#define reg_mprj_slave_sendx_req_sucess (*(volatile uint32_t *) 0x3000000c)
void main()
{
	int j;
