...
HD_PWD='/home/chenchingwen/Course2023/SoC/fir-cavarel/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log user_project_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source user_project_wrapper.tcl -notrace
